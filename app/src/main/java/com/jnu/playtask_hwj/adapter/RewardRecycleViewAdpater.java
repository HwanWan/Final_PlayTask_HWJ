...
public class RewardRecycleViewAdpater extends RecyclerView.Adapter<RewardRecycleViewAdpater.ViewHolder>  {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnCreateContextMenuListener  {
        ...
        public void onCreateContextMenu(ContextMenu contextMenu, View view, ContextMenu.ContextMenuInfo contextMenuInfo) {
            ...
            contextMenu.add(ContextMenu.NONE, 0, position, "添加新奖励");
            contextMenu.add(ContextMenu.NONE, 1, position, "修改该奖励");
            contextMenu.add(ContextMenu.NONE, 2, position, "已完成该奖励");
            contextMenu.add(ContextMenu.NONE, 3, position, "删除该奖励");
        }
        public ViewHolder(View rewardItemview) {
             ...
             */
            rewardItemview.setOnCreateContextMenuListener(RewardRecycleViewAdpater.ViewHolder.this);
        }
