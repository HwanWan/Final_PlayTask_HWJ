...
public class TaskRecycleViewAdpater extends RecyclerView.Adapter<TaskRecycleViewAdpater.ViewHolder>  {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnCreateContextMenuListener  {
        ...
        public void onCreateContextMenu(ContextMenu contextMenu, View view, ContextMenu.ContextMenuInfo contextMenuInfo) {
            ...
            contextMenu.add(ContextMenu.NONE, 0, position, "添加新任务");
            contextMenu.add(ContextMenu.NONE, 1, position, "修改该任务");
            contextMenu.add(ContextMenu.NONE, 2, position, "已完成该任务");
            contextMenu.add(ContextMenu.NONE, 3, position, "删除该任务");
        }
        public ViewHolder(View taskItemview) {
             ...
             */
            taskItemview.setOnCreateContextMenuListener(TaskRecycleViewAdpater.ViewHolder.this);
        }
